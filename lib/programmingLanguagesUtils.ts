// https://github.com/Testaustime/testaustime-frontend/blob/main/src/utils/programmingLanguagesUtils.ts

import { capitalizeFirstLetter, isStringNull } from './utils';
